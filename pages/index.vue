  ...
  <div>
    ...
    <div class="container mx-auto  px-4 py-16 rounded-t-lg">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div v-for="course in 8" :key="course" class="rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-600">
          <img src="/assets/img/course.jpg" alt="Course Image" class="w-full h-40 object-cover">
          <div class="p-4">
